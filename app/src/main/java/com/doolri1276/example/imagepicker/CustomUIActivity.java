...
import com.doolri1276.imagepicker.features.ImagePickerFragment;
import com.doolri1276.imagepicker.features.ImagePickerInteractionListener;
...
public class CustomUIActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.doolri1276.imagepicker.R.menu.ef_image_picker_menu_main, menu);
        return true;
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem menuDone = menu.findItem(com.doolri1276.imagepicker.R.id.menu_done);
        if (menuDone != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.doolri1276.imagepicker.R.id.menu_done) {
            imagePickerFragment.onDone();
            return true;
        }
        if (id == com.doolri1276.imagepicker.R.id.menu_camera) {
